...
public class PlayerController : MonoBehaviour
{
    ...
    void OnCollisionStay(Collision collisionInfo)
    {
        ...
        var acid = collisionInfo.gameObject.GetComponent<Acid>();
        if (lava != null) Health -= lava.DamagePerSecond * Time.fixedDeltaTime;
        if (acid != null) Health -= acid.DamagePerSecond * Time.fixedDeltaTime;
    }
